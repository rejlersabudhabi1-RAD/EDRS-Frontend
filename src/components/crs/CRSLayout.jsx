...
const CRSLayout = ({ children, title, description, icon, color }) => {
    ...
    const dashboardSections = {
        ...
        edrs: { title: 'EDRS Platform', icon: 'fas fa-file-alt', color: '#10b981', path: '/dashboard' },
        csr: {
            title: 'CRS Platform',
